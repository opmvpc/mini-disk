...
| T-015 | Fix : l'overlay F11 est positionné en unités mélangées (hors écran à DPI ≠ 1) ; unités logiques partout dans `ui_debug_overlay.c` | doing |
| [T-010](T-010-scan-bibliotheque.md) | Scan multi-thread, modèle SoA + StringTable, dialogue dossier, événements core → UI | done |
| [T-011](T-011-tags-audio.md) | Tags ID3v1/v2, Vorbis, MP4, APE, WAV/AIFF + durées exactes, fuzz ASan | doing |
